...
class PedidoControllerTest {
    ...
    private void init(){
        ...
        pedido2 = PedidoResponse.builder().id(2l).fechaEntrega(new Date("30/07/2024")).horaEntrega(new Date("30/07/2024 16:00:00"))
                ...
                .cliente(ClienteResponse.builder().id(1l).build())
                .build();
        pedido3 = PedidoResponse.builder().id(3l).fechaEntrega(new Date("20/06/2024")).horaEntrega(new Date("20/06/2024 08:00:00"))
                ...
                .cliente(ClienteResponse.builder().id(1l).build())
                .build();
        pedido4 = PedidoResponse.builder().id(4l).fechaEntrega(new Date("25/06/2024")).horaEntrega(new Date("25/06/2024 20:00:00"))
